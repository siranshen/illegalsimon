						...
						<form method="post">
							...
							<div class="auth-form-body">
								...
								<div class="form-group">
									...
									<span class="help-block">Send an email to this address to reset your password.</span>
								</div>
								
								<input type="submit" id="sendEmail" name="sendEmail" class="btn btn-info text-capitalized" value="Send">			
							</div>
						</form>
					</div>
				</div>
